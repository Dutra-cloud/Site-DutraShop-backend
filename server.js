...
// --- FUNÇÃO PARA CRIAR AS TABELAS (agora com orders e order_items) ---
...
app.get('/api/products/:id', async (req, res) => { /* ...código existente... */ });
...
// ======================================================
// --- NOVA ROTA DE CHECKOUT: Criar Pedido ---
// (A rota antiga de update-stock foi removida e substituída por esta)
// ======================================================
app.post('/api/orders', async (req, res) => {
    ...
    try {
        ...
        // Calcula o preço total no back-end para segurança
        let totalPrice = 0;
        ...
        // 2. Adiciona cada item na tabela 'order_items' e atualiza o estoque
        for (const item of items) {
            // Adiciona o item
            await client.query(
